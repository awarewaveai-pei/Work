...
if ([string]::IsNullOrWhiteSpace($dsn)) {
    throw @"
Neither SUPABASE_B_POSTGRES_DSN nor SUPABASE_POSTGRES_MCP_DSN is set.
Define SUPABASE_B_POSTGRES_DSN in User environment variables or in the MCP server env block.
"@
}
